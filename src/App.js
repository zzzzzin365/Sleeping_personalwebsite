                      ...
                      <div className="card__content">
                        ...
                        <button 
                          ...
                          onClick={() => {
                            setModalContent({
                              title: 'DeepPaper',
                              description: '基于<b>Vue</b>与<b>NLP等AI技术</b>开发的智能论文阅读与管理平台，用户可通过本平台实现智能论文管理与阅读、获得个性化咨询、文献推荐。\n\n✦ NLP + ML + RAG + OCR\n\ngithub地址：<https://github.com/zzzzzin365/DeepPaper.git" target="_blank">https://github.com/zzzzzin365/DeepPaper.git</a>',
                              image: '/p3_more.png'
                            });
                            setShowModal(true);
                          }}
                      ...
                      <div className="card__content">
                        ...
                        <button 
                          ...
                          onClick={() => {
                            setModalContent({
                              title: 'Coffee Shop',
                              description: '基于<b>Uniapp</b>开发的Coffee Shop 小程序。\n\n✦ 技术栈描述\n\ngithub地址：<a href="https://github.com/zzzzzin365/project7.git" target="_blank">https://github.com/zzzzzin365/project7.git</a>',
                              image: '/p7_more.png'
                            });
                            setShowModal(true);
                          }}
