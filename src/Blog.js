    ...
    <div className="blog-page">
      ...
      <div className="social-icons" style={{
        ...
        <div className="container">
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="icon icon-instagram">
          ...
          <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="icon icon-dis">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
